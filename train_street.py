...
if __name__ == '__main__':
    ...
    eval_area = 'hudsonriver5k'
    eval_opt.area = eval_area 
    eval_opt.no_rotations = True
    eval_opt.no_map_random_crop = True 
    eval_opt.serial_batches = False 
    ...
    epoch_eval_opt.isTrain = False 
    epoch_eval_opt.num_augmentations = 1
    epoch_eval_opt.serial_batches = True 
    epoch_eval_opt.drop_last = False
