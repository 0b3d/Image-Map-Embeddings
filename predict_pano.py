"""Predict features in the streetlearn dataset (panorama only).

Example (You need to train models first or download pre-trained models from our website):
        Predict embedded descriptors for Y domain:
        
        python predict_pano.py --name PF_pano --model pano --batch_size 512
        --area hudsonriver5k --embedding_dim 16 --no_local_rotation --no_rotations --no_vlad 
        --tile_zoom 18 -d pano --epoch 10 --panorama_mode list
